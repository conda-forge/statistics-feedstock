About statistics-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/statistics-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/digitalemagine/py-statistics
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1966&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/statistics-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `statistics` can be installed with `conda`:
...
```
mamba install statistics
```

It is possible to list all of the versions of `statistics` available on your platform with `conda`:
...
```
mamba search statistics --channel conda-forge
```
...
mamba repoquery search statistics --channel conda-forge

# List packages depending on `statistics`:
mamba repoquery whoneeds statistics --channel conda-forge

# List dependencies of `statistics`:
mamba repoquery depends statistics --channel conda-forge
```
